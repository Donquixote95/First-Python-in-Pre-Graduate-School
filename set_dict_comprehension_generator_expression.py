...
# 미리 처리해두고 요청이 있을 때 곧바로 데이터를 응답해야 하는 상황에는 리스트 내포를 사용해야 한다.

#%%
# 예외 2. 원본의 변경이 반영되면 안 되는 상황
original = [1,2,3,4,5]
list_comprehension = [str(i) for i in original]
genorator_expression = (str(i) for i in original)
...
print(",".join(list_comprehension))
print(",".join(genorator_expression))
# %%
